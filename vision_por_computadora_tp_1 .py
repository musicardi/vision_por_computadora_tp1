...
"""# Explicación del Código: White Patch + Histogramas
...
💡 **Idea clave:** elimina dominantes de color; por ejemplo, si la imagen está azulada, el azul se normaliza y los otros canales se ajustan proporcionalmente.
